...
interface IFundingOracle {
    /// @notice Resample the cached funding rate for `marketId` using perp `lastPriceX18`.
    ...
    function update(uint256 marketId, uint256 lastPriceX18) external returns (bool updated);

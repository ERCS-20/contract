...
- **Exchange**: `Orbix` (website: `orbix.exchange`) is the planned decentralized exchange for expanding liquidity in the ERCS-20 ecosystem. Its goal is to provide deeper market depth and to serve as the execution layer for spot markets, derivatives, and incentive mechanisms over time.（A Trust-Minimized Capital Market Infrastructure.）
